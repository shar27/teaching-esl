...
<div className="bg-black text-white">
      <Bgimg />
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#f3f4f5" fill-opacity="1" d="M0,0L1440,288L1440,0L0,0Z"></path></svg>
     <div className="grid grid-cols-2 gap-2 ">
     
      <h1 className="text-4xl text-white font-serif text-center sm:text-left md:text-left font-bold mt-20 ml-4">Are you tired of searching for words when you speak?
           
           <br/>
           <br/>
           Starting talking today, why not? it's free. </h1>
...
<div className="border-2">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#000000" fill-opacity="1" d="M0,320L1440,0L1440,320L0,320Z"></path></svg>
      <Icons />
    <IconsText />
