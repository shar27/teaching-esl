...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#18181B" fill-opacity="1" d="M0,288L48,261.3C96,235,192,181,288,144C384,107,480,85,576,106.7C672,128,768,192,864,218.7C960,245,1056,235,1152,218.7C1248,203,1344,181,1392,170.7L1440,160L1440,0L1392,0C1344,0,1248,0,1152,0C1056,0,960,0,864,0C768,0,672,0,576,0C480,0,384,0,288,0C192,0,96,0,48,0L0,0Z"></path></svg>
      ...
      <div className="text-center mt-20">
        <p className="text-2xl font-bold text-black font-serif ">
          ...
          Mandarin.
          <br /> <br />
          So, I asked Mark – <span className="italic text-2xl font-bold">"how are you able to speak both languages so well?"</span> I
          said to him:<span className="italic text-2xl font-bold"> "I’ve been studying Chinese for 6 months and I still feel
          like I can’t have a conversation."</span>
          <br />
          <br /> Mark was just one of many fluent foreign language speakers who had I met.
          They didn’t have a particular talent for learning languages,but they all had one thing in common:
          they had a good solid learning strategy. That’s when I realised the method for
          ...
          <p>
            ...
            that the learning strategy is not effective and it’s why when they get to real
            world situations they are always feeling CONFUSED and STRESSED.
          </p>
          <br />
          <p>
            The frustration and stress both I and countless other
            students experienced is the reason why I created my own course. A TRIED and
          ...
          <ul className="mt-20">
            <div className="grid grid-rows-1">
              <li className="mt-20">
                I will teach you to speak English fluently to help you get better jobs,
                or to be more involved in business meetings.
              </li>
